...
describe("put update product" , ()=>{
  ...
  it("should return 201 if product updated in shopping list",  () => {
    jest.spyOn(validator, 'validationResult').mockImplementationOnce(() => ({
      isEmpty: jest.fn(() => true),
      isNaN: jest.fn(() => {return false})
    }));
    ...
    shoppingList.products = [
      { product: { productName: 'product 1', price: 300, quantityAvailable: 4 }, count: 1 }]
    const mockResponse = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
      json: jest.fn(),
...
describe("delete product" , ()=>{
  ...
  it("should return 204 if product deleted from shopping list",  () => {
    jest.spyOn(validator, 'validationResult').mockImplementationOnce(() => ({
      isEmpty: jest.fn(() => true),
      isNaN: jest.fn(() => {return false})
    }));
    ...
    shoppingList.products = [
      { product: { productName: 'product 2', price: 300, quantityAvailable: 4 }, count: 1 }]
    const mockResponse = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
      json: jest.fn(),
